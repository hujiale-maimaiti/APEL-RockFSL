...
class APELRelationExpertOutput(NamedTuple):
...
class APELLocalRelationExpert(nn.Module):
    """Complete support-built, query-independent APEL relation expert."""
    ...
    def forward_with_bank(
        ...
        return APELRelationExpertOutput(
            relation=relation,
